package com.example.propertyanimation.refresh;
...
public class RefreshActivity extends AppCompatActivity {
  ...
  private class RecyclerViewAdapter extends RecyclerView.Adapter<ItemViewHolder> {
    ...
    @Override public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View view =
          LayoutInflater.from(RefreshActivity.this).inflate(R.layout.list_item, parent, false);
    ...
    @Override public void onBindViewHolder(final ItemViewHolder holder, final int position) {
      ...
      holder.tv.setOnClickListener(new View.OnClickListener() {
        @Override public void onClick(View v) {
          Toast.makeText(RefreshActivity.this, "我是" + position + "号", Toast.LENGTH_SHORT).show();
        }
      });
    }
  }
